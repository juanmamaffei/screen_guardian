...
class ScreenTimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create screen_time' do
    assert_difference('ScreenTime.count') do
      post screen_times_url,
           params: { screen_time: { app_name: @screen_time.app_name, duration: @screen_time.duration,
                                    screen_type: @screen_time.screen_type } }
    end
  ...
  test 'should update screen_time' do
    patch screen_time_url(@screen_time),
          params: { screen_time: { app_name: @screen_time.app_name, duration: @screen_time.duration,
                                   screen_type: @screen_time.screen_type } }
